...
<p class="reveal" style="color:var(--text-soft);max-width:54ch;margin-bottom:2rem;">Things I've built, explored or tested; both in my own time and from my undergrad</p>
