...
<p class="reveal" style="color:var(--text-soft);max-width:54ch;margin-bottom:2rem;">Things I've built, explored, or written up — from coursework spin-offs to weekend experiments.</p>
